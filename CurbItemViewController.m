...
@interface CurbItemViewController ()<UITableViewDataSource,UITableViewDelegate,UITextFieldDelegate,QRadioButtonDelegate>
...
@implementation CurbItemViewController
...
- (void)payButtonClick:(NSNotification *)info{
    ...
    _payController.pay_tool = self.pay_tool;
    ...
    _payController.hire_field = self.field;
